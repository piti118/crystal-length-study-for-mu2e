...
def doOneFit(E,range=(95.,110.),mean=104.,sigma=1.,n=20.,alpha=0.5,N=80000,
        limit_N=(1000,100000),limit_n=(0.1,80.), limit_mean=(90,106), limit_sigma=(0.3,5.),limit_alpha=(0.,5.)):
    ...
    while not good and itry<5:
        try:
            ...
            first =False
            fit,m = fit_binpoisson(eeg,E,maxcalls=800000,bins=100,
